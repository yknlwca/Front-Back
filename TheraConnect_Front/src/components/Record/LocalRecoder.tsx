    ...
    return (
        <div className="container text-center">
            {/* <MicSpeakerRecorderPolyFill /> */}
                <span className=' text-lg font-bold mb-1'>화면 녹화</span>
            <div className="mb-2 flex w-full justify-center items-center flex-col pt-4">
                <span className=' text-lg font-bold mb-2'>⚠️크롬을 사용하여 녹화해주세요. Safari에서는 스피커 녹화가 불가능합니다.</span>
                {/* 옵션 */}
                <div className='flex gap-6 pb-2'>
                    <div className="ml-4 form-control border rounded-md bg-black bg-opacity-10   w-[200px]">
                        <label className="cursor-pointer label">
                            <span className="label-text ">마이크 녹음</span>
                            <input
                                type="checkbox"
                        ...
                        <label className="cursor-pointer label">
                            <span className="label-text ">스피커 녹음</span>
                            <input
                                type="checkbox"
                        ...
                        <label className="cursor-pointer label">
                            <span className="label-text ">화면 녹화</span>
                            <input
                                type="checkbox"
